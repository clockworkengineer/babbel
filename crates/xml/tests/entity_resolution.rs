...
fn test_predefined_entities() {
    let xml =
        r#"<note message="&quot;Hello &amp; World&quot;">5 &gt; 3 &amp;&amp; 2 &lt; 4</note>"#;
...
fn test_numeric_character_references() {
    ...
    let hex_res = mapper
        .expand("&#x41;&#x42;&#x43;")
        .expect("Hex entity expansion should work");
    assert_eq!(hex_res, "ABC");

    // Decimal references
    let dec_res = mapper
        .expand("&#65;&#66;&#67;")
        .expect("Decimal entity expansion should work");
    assert_eq!(dec_res, "ABC");

    // Unicode character euro sign
    let euro_res = mapper
        .expand("&#x20AC;")
        .expect("Euro symbol expansion should work");
    assert_eq!(euro_res, "€");
}
...
fn test_custom_entity_mapper_registration() {
    ...
    let expanded = mapper
        .expand("Welcome to &trade;!")
        .expect("Recursive entity expansion should work");
